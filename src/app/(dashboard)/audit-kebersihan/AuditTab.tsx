...
import { Camera, X, CheckCircle2, AlertTriangle, Users, User } from "lucide-react";
...
export default function AuditTab() {
  ...
  return (
    <div className="space-y-4 pb-32">
      <p className="text-sm text-gray-500">Sesi {sesiUser === "pagi" ? "Pagi" : "Malam"} — mengaudit tugas untuk <b>{labelTgl(tanggalTugas)}</b>. Centang = sudah lulus dicek; hilangkan centang kalau ada yang gagal.</p>
