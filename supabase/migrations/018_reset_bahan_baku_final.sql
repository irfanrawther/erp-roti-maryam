-- ============================================================
-- 018_reset_bahan_baku_final.sql
-- Bersihkan & set stok awal 15 bahan baku final
-- Jalankan di Supabase SQL Editor
-- ============================================================

-- 1. Nonaktifkan semua bahan yang tidak ada di list
UPDATE bahan_baku
SET aktif = false
WHERE nama NOT IN (
...
-- 2. Aktifkan & pastikan satuan benar untuk 15 bahan
...
-- 3. Set stok awal (langsung update, tidak lewat trigger)
...
-- 4. Verifikasi — harus menampilkan tepat 15 baris
